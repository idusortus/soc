...
export function BingoModal({ onDismiss }: BingoModalProps) {
  return (
    <div 
      className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-[fade-in_0.2s_ease-out]"
      role="dialog"
      aria-modal="true"
    ...
    >
      <div className="bg-white rounded-2xl p-8 max-w-xs w-full text-center shadow-2xl animate-[bounce_0.5s_ease-out] border-2 border-amber-200">
        <div className="text-6xl mb-4 animate-[bounce_1s_ease-in-out_infinite]" aria-hidden="true">🎉</div>
        <h2 id="bingo-title" className="text-4xl font-bold bg-gradient-to-r from-amber-500 to-yellow-500 bg-clip-text text-transparent [.no-gradient_&]:text-amber-500 mb-3">
          BINGO!
        </h2>
